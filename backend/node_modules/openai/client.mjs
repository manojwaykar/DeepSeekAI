...
export class OpenAI {
     ...
     */
    constructor({ baseURL = readEnv('OPENAI_BASE_URL'), apiKey = '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', organization = readEnv('OPENAI_ORG_ID') ?? null, project = readEnv('OPENAI_PROJECT_ID') ?? null, webhookSecret = readEnv('OPENAI_WEBHOOK_SECRET') ?? null, ...opts } = {}) {
